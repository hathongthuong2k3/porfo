  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/thong.thuongha"
            ...
            <li>
              <a
                href="https://www.instagram.com/thongthuongha?igsh=MTU1Nmt2cmF0cjVvcQ=="
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ha-thong-thuong"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by T.T.Ha</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
